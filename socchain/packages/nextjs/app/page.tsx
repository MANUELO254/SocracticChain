...
import { Award, CheckCircle, Shield, Users, Vote } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-indigo-50">
      <div className="container mx-auto px-4 py-12">
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-slate-800 mb-4">Decentralized Democracy</h1>
        ...
        <div className="max-w-4xl mx-auto mb-16">
          <div className="bg-white rounded-2xl shadow-lg p-8">
            <h2 className="text-2xl font-semibold text-slate-800 mb-8 text-center">Election Progress</h2>
              ...
              {phases.map(phase => {
                ...
                return (
                  <div key={phase.id} className="flex flex-col items-center relative z-10" style={{ flex: 1 }}>
                    <div
                      className={`w-16 h-16 rounded-full ${getStatusColor(phase.status)} 
        ...
        <div className="max-w-2xl mx-auto mb-12">
          <div className="bg-white rounded-2xl shadow-lg p-8 border-t-4 border-indigo-500">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h3 className="text-2xl font-bold text-slate-800 mb-2">Election Phase Active</h3>
                <p className="text-slate-600">Voters: Cast your vote in the weighted lottery to select the winner</p>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              >
                <div
                  className={`w-12 h-12 bg-${item.color}-100 rounded-full flex items-center 
        ...
        <div className="max-w-4xl mx-auto mt-16 text-center">
          <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl shadow-2xl p-12 text-white">
            ...
            <p className="text-indigo-100 mb-8 text-lg">Be part of a transparent, decentralized governance system</p>
            <div className="flex gap-4 justify-center flex-wrap">
              <Link href="/Identity">
                <button
                  className="bg-white text-indigo-600 font-semibold px-8 py-3 rounded-xl 
              ...
              <Link href="/nominations">
                <button
                  className="bg-indigo-700 text-white font-semibold px-8 py-3 rounded-xl 
              ...
              <Link href="/vetting">
                <button
                  className="bg-purple-700 text-white font-semibold px-8 py-3 rounded-xl 
              ...
              <Link href="/election">
                <button
                  className="bg-yellow-700 text-white font-semibold px-8 py-3 rounded-xl 
              ...
              <Link href="/admin">
                <button
                  className="bg-red-700 text-white font-semibold px-8 py-3 rounded-xl 
